            ...
            <div className="mb-8 flex items-center justify-between gap-8">
              <div>
                <Typography className="text-3xl font-poppins ">
                  Rincian Data Peminjaman Barang
                </Typography>
              </div>
            </div>
          </CardHeader>
          ...
          <form className="mx-auto max-w-4xl">
            <div className="bg-gray-100 shadow rounded-lg py-2 space-y-8 px-10">
              <div className="flex items-center gap-x-6  ">
                ...
                <div className="">
                  <div className=" mb-32  flex justify-center bg-white rounded-lg border border-dashed border-gray-900/25 px-16 py-16">
